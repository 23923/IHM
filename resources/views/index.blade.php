    ...
    <section class="special_cource padding_top">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="single_special_cource">
                        <img src="{{ asset('img/special_cource_2.png') }}" class="special_img" alt="">
                        <div class="special_cource_text">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="single_special_cource">
                        <img src="{{ asset('img/special_cource_3.png') }}" class="special_img" alt="">
                        <div class="special_cource_text">
                    ...
                    <div class="textimonial_iner owl-carousel">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xl-2 col-sm-4">
                                    <div class="testimonial_slider_img">
                                        <img src="{{ asset('img/testimonial_img_1.png') }}" alt="#">
                                    </div>
                                </div>
                        ...
                        <div class="testimonial_slider">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xl-2 col-sm-4">
                                    <div class="testimonial_slider_img">
                                        <img src="{{ asset('img/testimonial_img_2.png') }}" alt="#">
                                    </div>
                                </div>
                                <div class="col-xl-4 d-none d-xl-block">
                                    <div class="testimonial_slider_text">
                        ...
                        <div class="testimonial_slider">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xl-2 col-sm-4">
                                    <div class="testimonial_slider_img">
                                        <img src="{{ asset('img/testimonial_img_3.png') }}" alt="#">
                                    </div>
                                </div>
                                <div class="col-xl-4 d-none d-xl-block">
                                    <div class="testimonial_slider_text">
